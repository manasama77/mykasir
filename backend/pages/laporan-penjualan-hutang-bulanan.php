...
WHERE MONTH(penjualan.date_create) = '$bulan'
...
LEFT JOIN tbl_penjualan_hutang AS master_hutang ON master_hutang.kode_penjualan = penjualan.kode_penjualan
WHERE MONTH(penjualan.date_create) = '$bulan' AND master_hutang.status = 'hutang'");
...
<head>
    ...
    <title>UD Mandiri Cahaya Abadi - Laporan Penjualan Hutang <?=$bulan;?></title>
