...
WHERE pembelian.tanggal_order >= '$tanggal_awal' AND pembelian.tanggal_order <= '$tanggal_akhir'
...
<head>
    ...
    <title>UD Mandiri Cahaya Abadi - Laporan Pembelian Lunas <?=$tanggal_awal;?> s/d <?=$tanggal_akhir;?></title>
			...
			<div class="col-lg-12">
					<table class="table table-bordered">
						<thead>
							<tr>
								<th colspan="7">
									<h4 class="header">Laporan Daftar Transaksi Pembelian Lunas</h4>
									<?= $head_alamat; ?>
								</th>
							</tr>
							<tr>
						...
						<?php
							...
							while($data_vendor = mysqli_fetch_assoc($q_vendor)){
								...
								*
								...
								WHERE pembelian.id_vendor = '$id_vendor' AND pembelian.tanggal_order >= '$tanggal_awal' AND pembelian.tanggal_order <= '$tanggal_akhir' AND pembelian.status = '1'");
						...
						?>
								...
								<tr>
									...
									<td style="text-align:center;"><?=$data_pembelian['tanggal_pelunasan'];?></td>
						...
						<tfoot style="font-size:12px;">
							<tr>
								<th style="text-align:left;" colspan="3">Jumlah Transaksi <?=$row_pembelian;?></th>
								<th style="text-align:right;">Total Pembelian</th>
