...
WHERE DATE(penjualan.date_create) >= '$tanggal_awal' AND DATE(penjualan.date_create) <= '$tanggal_akhir'
...
LEFT JOIN tbl_penjualan_hutang AS master_hutang ON master_hutang.kode_penjualan = penjualan.kode_penjualan
WHERE DATE(penjualan.date_create) >= '$tanggal_awal' AND DATE(penjualan.date_create) <= '$tanggal_akhir' AND master_hutang.status = 'hutang'");
...
<head>
    ...
    <title>UD Mandiri Cahaya Abadi - Laporan Penjualan Hutang <?=$tanggal_awal;?> s/d <?=$tanggal_akhir;?></title>
