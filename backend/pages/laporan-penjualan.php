...
<div class="row">
	<div class="col-lg-12">
		<h2 class="header">Laporan Penjualan</h2>
	</div>
</div>
<hr>
<div class="row">
	<!--div class="col-lg-4">
		...
		<hr>
		<form class="form-inline" action="laporan-penjualan-harian.php" method="post" target="_blank">
	...
	<div class="col-lg-4">
		...
		<hr>
		<form class="form-inline" action="laporan-penjualan-bulanan.php" method="post" target="_blank">
			<div class="form-group">
				<label>Bulan</label>
...
<div class="row">
	<div class="col-lg-12">
		...
		<hr>
		<form class="form-inline" action="laporan-penjualan-berjarak.php" method="post" target="_blank">
			<div class="form-group">
