...
<head>
    ...
    <meta name="description" content="Application for Mandiri Cahaya Abadi">
	<meta name="author" content="RIMSMEDIA">
    <title>Mandiri Cahaya Abadi - Laporan Beban Operasional <?=$tanggal_harian;?> </title>
		...
		<div class="row">
			<div class="col-lg-12">
					<table class="table table-bordered">
						...
						FROM trx
						WHERE
						DATE(trx.tgl_reg) = '$tanggal_harian'
						AND trx.led = '$lib_id'
