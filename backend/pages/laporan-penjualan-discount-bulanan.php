...
WHERE MONTH(tbl_list_penjualan_event.date_create) = '$bulan'");

$q_sum_penjualan = mysqli_query($con, "SELECT SUM(lpe.total_harga) AS sum_grand_total FROM tbl_list_penjualan_event AS lpe WHERE MONTH(lpe.date_create) = '$bulan'");
...
<head>
    ...
    <title>UD Mandiri Cahaya Abadi - Laporan Penjualan Discount <?=$bulan;?></title>
