...
$id_supplier_berjarak = $_REQUEST['id_supplier_berjarak'];
...
WHERE pembelian.tanggal_order >= '$tanggal_awal' AND pembelian.tanggal_order <= '$tanggal_akhir' AND pembelian.status = '0'
AND pembelian.id_vendor = '$id_supplier_berjarak'
...
<head>
    ...
    <title>UD Mandiri Cahaya Abadi - Laporan Pembelian Hutang <?=$tanggal_awal;?> s/d <?=$tanggal_akhir;?></title>
						...
						<?php
							...
							while($data_vendor = mysqli_fetch_assoc($q_vendor)){
								...
								*
								...
								WHERE pembelian.id_vendor = '$id_vendor' AND pembelian.tanggal_order >= '$tanggal_awal' AND pembelian.tanggal_order <= '$tanggal_akhir' AND pembelian.status = '0'");
