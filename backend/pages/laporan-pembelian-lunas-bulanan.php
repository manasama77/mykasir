...
<head>
    ...
    <title>UD Mandiri Cahaya Abadi - Laporan Pembelian Lunas <?=bulan_indo($bulan);?></title>
						...
						<?php
							...
							while($data_vendor = mysqli_fetch_assoc($q_vendor)){
								...
								*
								...
								WHERE pembelian.id_vendor = '$id_vendor' AND MONTH(pembelian.tanggal_order) = '$bulan' AND pembelian.status = '1'");
