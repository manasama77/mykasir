...
$id_supplier_bulanan = $_REQUEST['id_supplier_bulanan'];
...
AND pembelian.id_vendor = '$id_supplier_bulanan'
...
<head>
    ...
    <title>UD Mandiri Cahaya Abadi - Laporan Pembelian Hutang <?=bulan_indo($bulan);?></title>
						...
						<?php
							...
							while($data_vendor = mysqli_fetch_assoc($q_vendor)){
								...
								*
								...
								WHERE pembelian.id_vendor = '$id_vendor' AND MONTH(pembelian.tanggal_order) = '$bulan' AND pembelian.status = '0'");
