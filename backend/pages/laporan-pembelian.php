...
<div class="row">
	<div class="col-lg-12">
		<h2 class="header">Laporan Pembelian</h2>
	</div>
</div>
<hr>
<div class="row">
	<!--div class="col-lg-4">
		<h4>Laporan Pembelian Harian</h4>
		<hr>
		<form class="form-inline" action="laporan-pembelian-harian.php" method="post" target="_blank">
	...
	<div class="col-lg-12">
		...
		<hr>
		<form class="form-inline" action="laporan-pembelian-bulanan.php" method="post" target="_blank">
			<div class="form-group">
				<label>Bulan</label>
...
<div class="row">
	<div class="col-lg-12">
		...
		<hr>
		<form class="form-inline" action="laporan-pembelian-berjarak.php" method="post" target="_blank">
			<div class="form-group">
