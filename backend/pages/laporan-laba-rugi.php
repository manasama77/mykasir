...
<div class="row">
	<!-- <div class="col-lg-4">
		<h4>Laporan Laba Rugi Harian</h4>
		<hr>
		<form class="form-inline" action="laporan-laru-harian.php" method="post" target="_blank">
	...
	<div class="col-lg-12">
		...
		<hr>
		<form class="form-inline" action="laporan-laru-bulanan.php" method="post" target="_blank">
			<div class="form-group">
				<label>Bulan</label>
...
<div class="row">
	<div class="col-lg-12">
		<h4>Laporan Laba Rugi Berjarak</h4>
		<hr>
		<form class="form-inline" action="laporan-laru-berjarak.php" method="post" target="_blank">
			<div class="form-group">
