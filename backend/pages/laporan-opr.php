...
<div class="row">
	<div class="col-lg-12">
		<h2 class="header">Laporan Operasional </h2>
	</div>
</div>
<hr>
<div class="row">
	<!--<div class="col-lg-4">
		<h4>Laporan Operasinal Harian</h4>
		<hr>
	...
	<div class="col-lg-4">
		<h4>Laporan Operasinal Bulanan</h4>
		<hr>
		<form class="form-inline" action="#.php" method="post" target="_blank">
			<div class="form-group">
				<label>Bulan</label>
...
<div class="row">
	<div class="col-lg-12">
		<h4>Laporan Operasinal Berjarak</h4>
		<hr>
		<form class="form-inline" action="laporan-opr-bulanan.php" method="post" target="_blank">
			<div class="form-group">
