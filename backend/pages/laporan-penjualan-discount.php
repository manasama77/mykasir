...
<div class="row">
	<div class="col-lg-12">
		<h2 class="header">Laporan Penjualan Discount</h2>
	</div>
</div>
<hr>
<div class="row">
	<!--div class="col-lg-4">
		...
		<hr>
		<form class="form-inline" action="laporan-penjualan-discount-harian.php" method="post" target="_blank">
	...
	<div class="col-lg-4">
		...
		<hr>
		<form class="form-inline" action="laporan-penjualan-discount-bulanan.php" method="post" target="_blank">
			<div class="form-group">
				<label>Bulan</label>
...
<div class="row">
	<div class="col-lg-12">
		<h4>Laporan Penjualan Berjarak</h4>
		<hr>
		<form class="form-inline" action="laporan-penjualan-discount-berjarak.php" method="post" target="_blank">
			<div class="form-group">
