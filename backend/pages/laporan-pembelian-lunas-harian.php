...
<head>
    ...
    <title>UD Mandiri Cahaya Abadi - Laporan Pembelian Lunas <?=$tanggal_harian;?></title>
						...
						<?php
							...
							while($data_vendor = mysqli_fetch_assoc($q_vendor)){
								...
								*
								...
								WHERE pembelian.id_vendor = '$id_vendor' AND pembelian.tanggal_order = '$tanggal_harian' AND pembelian.status = '1'");
