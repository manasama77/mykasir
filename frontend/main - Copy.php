...
<div class="col-lg-4">
	<div class="row">
		<div id="cbarcode" class="form-group" style="text-align:right;">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control input-xs" id="barcode" name="barcode" placeholder="Barcode" maxlength="15" accesskey="b" title="Gunakan Alt + B untuk langsung memasukan barcode..." data-toggle="tooltip" data-placement="right" onChange="checkBarcode('bar');">
...
<div class="col-lg-5" align="right">
	...
	<div class="row form-inline">
		...
		<div class="col-lg-offset-1 col-lg-6">
			<input type="text" id="pembayaran" name="pembayaran" class="form-control input-sm pembayaran" style="text-align:right;width:150px;" placeholder="Pembayaran" onChange="bayar();" maxlength="12" accesskey="m" title="Gunakan Alt + M untuk langsung memasukan Pembayaran..." data-toggle="tooltip" data-placement="left">
		</div>
	</div>
	<!--div class="row form-inline">
